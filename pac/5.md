...
* ## <font color="sandybrown">典型环节及其传递函数</font> 
    ...
    * 环节的分类
        ...
        * <font color="color">一阶微分环节</font>:$\tau s+1$  
            输出量正比于输入量的微分.
        ...
        * <font color="color">二阶微分环节</font>:$\tau^2s^2+2\zeta \tau s+1$
        ...
        * <font color="color">惯性环节</font>:$\frac{1}{Ts+1}$ 
            凡运动方程为下面一阶微分方程
        ...
        * <font color="color">震荡环节</font>:$\frac{1}{T^2s^2+2\zeta Ts+1}$
        ...
        * <font color="color">延迟环节</font>:$e^{-\tau s}$  
